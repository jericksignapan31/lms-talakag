...
@Component({
    ...
    template: `
            ...
            <p-table [value]="students" responsiveLayout="scroll" [paginator]="true" [rows]="10" [globalFilterFields]="['lrn', 'name', 'email']">
                ...
                <ng-template pTemplate="body" let-student>
                    <tr>
                        ...
                        <td>
                            <button pButton pRipple type="button" pButton icon="pi pi-pencil" class="p-button-rounded p-button-info mr-2" (click)="openEditDialog(student)" title="Edit Student"></button>
                            <button pButton pRipple type="button" icon="pi pi-trash" class="p-button-rounded p-button-danger" (click)="deleteStudent(student.id)" title="Delete Student"></button>
                        </td>
                    </tr>
                </ng-template>
        ...
        <!-- Add/Edit Dialog -->
        <p-dialog [(visible)]="displayDialog" [header]="isEditMode ? 'Edit Student' : 'Add New Student'" [modal]="true" [style]="{ width: '50vw' }" (onHide)="hideDialog()">
            <div class="form">
                <div class="field">
                    <label>LRN</label>
                    <input type="text" pInputText [(ngModel)]="studentForm.lrn" [disabled]="isEditMode" placeholder="Enter LRN" />
                </div>

                <div class="field">
                    <label>Name</label>
                    <input type="text" pInputText [(ngModel)]="studentForm.name" placeholder="Enter Full Name" />
                </div>

                <div class="field">
                    <label>Email</label>
                    <input type="email" pInputText [(ngModel)]="studentForm.email" placeholder="Enter Email" />
                </div>
                ...
                <div class="field">
                    ...
                    <input type="date" pInputText [(ngModel)]="studentForm.birthDate" />
                </div>

                <div class="field">
                    <label>Address</label>
                    <input type="text" pInputText [(ngModel)]="studentForm.address" placeholder="Enter Address" />
                </div>

                <div class="field">
                    <label>Barangay</label>
                    <input type="text" pInputText [(ngModel)]="studentForm.barangay" placeholder="Enter Barangay" />
                </div>

                <div class="field">
                    <label>Municipality</label>
                    <input type="text" pInputText [(ngModel)]="studentForm.municipality" placeholder="Enter Municipality" />
                </div>

                <div class="field">
                    <label>Province</label>
                    <input type="text" pInputText [(ngModel)]="studentForm.province" placeholder="Enter Province" />
                </div>

                <div class="field">
                    <label>Contact Number</label>
                    <input type="tel" pInputText [(ngModel)]="studentForm.contactNumber" placeholder="Enter Contact Number" />
                </div>
            ...
            <ng-template pTemplate="footer">
                ...
                <button pButton label="Save" icon="pi pi-check" (click)="saveStudent()" [loading]="saving"></button>
            </ng-template>
        </p-dialog>
